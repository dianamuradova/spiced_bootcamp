...
monday_df = pd.read_csv('~/git/diana/data/supermarket_analysis/monday.csv', sep=";")
tuesday_df = pd.read_csv('~/git/diana/data/supermarket_analysis/tuesday.csv', sep = ";")
wednesday_df = pd.read_csv('~/git/diana/data/supermarket_analysis/wednesday.csv', sep = ";")
thursday_df = pd.read_csv('~/git/diana/data/supermarket_analysis/thursday.csv', sep = ";")
friday_df = pd.read_csv('~/git/diana/data/supermarket_analysis/friday.csv', sep = ";")
